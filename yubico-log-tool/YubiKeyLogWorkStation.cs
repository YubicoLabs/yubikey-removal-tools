 ...
 **/
public class YubiKeyLogWorkStation
{
    ...
    private void YubiKeyRemoved(object? sender, YubiKeyDeviceEventArgs eventArgs)
    {
        ...
        if (_yubikey != null)
        {
            LogInfo(Environment.UserName + " removed a " + _yubikey.Name + ".", 4800);
        }
    }
    ...
    private void YubiKeyInserted(object? sender, YubiKeyDeviceEventArgs eventArgs)
    {
        ...
        if (_yubikey != null)
        {
            ...
            LogInfo(Environment.UserName + " inserted a " + _yubikey.Name + ".", 6416);
        }
    }
